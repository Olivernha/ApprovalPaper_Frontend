  ...
  <div class="flex items-center mb-4 flex-wrap md:flex-nowrap">
    ...
    <div class="ml-auto flex items-center gap-2">
      ...
      <div class="relative w-64">
        ...
        <div v-if="documentTypeStore.isLoading" class="w-full px-4 py-2 border border-gray-300 rounded-md bg-gray-100">
        ...
        <div v-if="documentTypeStore.isLoading" class="absolute right-3 top-1/2 transform -translate-y-1/2">
          <div class="animate-spin rounded-full h-4 w-4 border-b-2 border-gray-700"></div>
        </div>
